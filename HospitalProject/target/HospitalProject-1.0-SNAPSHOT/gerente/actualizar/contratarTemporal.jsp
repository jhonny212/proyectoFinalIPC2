<%-- 
    Document   : contratarTemporal
    Created on : 20/10/2019, 10:04:40 AM
    Author     : jhonny
--%>
...
<html>
    ...
    if(request.getParameter("error").equals("error")){
      String alert="alert('"+"Error al contratar"+"');";
   ...
   <br>
        ...
        <form class="fc1" action="/HospitalProject/servletgerente" method="GET" autocomplete="off">
            ...
            <tr>
                ...
                <td><input type="number" name="horas" placeholder="mesess de trabajo" id=""></td>
            ...
            <select name="empleo"  id="">
                    <% 
                        LinkedList<String> tmss=empleado.empleos();
                    for(int i=0; i<tmss.size();i++){
                    out.print("<option>"+tmss.get(i)+"</option>");
                    }
